					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="/java_web_jsp_servlet_jdbc_mysql/admin-home">Admin-Home</a>
							</li>
						</ul>
						<!-- /.breadcrumb -->
					</div>
										...
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<a flag="info"
												   ...
												   title='Add New' href='<c:url value="/admin-new-list?type=edit"/>'>
															<span>
																<i class="fa fa-plus-circle bigger-110 purple"></i>
															</span>
												</a>
												<button id="btnDelete" type="button"
														class="dt-button buttons-html5 btn btn-white btn-primary btn-bold" data-toggle="tooltip" title='Delete New'>
																<span>
