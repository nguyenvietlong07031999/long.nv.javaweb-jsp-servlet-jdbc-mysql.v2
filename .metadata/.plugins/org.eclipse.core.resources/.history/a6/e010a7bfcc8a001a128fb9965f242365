                        ...
                        <form id="formSubmit">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="categoryCode" name="categoryCode">
                                        <c:if test="${empty model.categoryCode}">
                                            <option value="">Choose category of new</option>
                                        ...
                                        <c:if test="${not empty model.categoryCode}">
                                            ...
                                            <option value="">Choose Category of Car</option>
                                        </c:if>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                 <div class="col-sm-12">
                                    ...
                                    <input type="button" class="btn btn-secondary  btn-bold" id="btnAddOrUpdateNew" name="content" value="Update old new"/>
                                    </c:if>
                                    <c:if test="${empty model.id}">
                                    <input type="button" class="btn btn-secondary btn-bold" id="btnAddOrUpdateNew" name="content" value="Add a new"/>
                                    </c:if>
                                </div>
                            </div>
