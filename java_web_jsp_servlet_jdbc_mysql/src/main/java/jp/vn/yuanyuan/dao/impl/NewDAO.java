...
public class NewDAO extends AbstractDAO<NewModel> implements INewDAO{
	...
	public List<NewModel> findAll(Pageble pageble) {
		...
		if(pageble.getStrCategory()!=null) {
			sql.append(" where categoryid =(select id from category where code=\"" +pageble.getStrCategory()+"\")"+"");
		}
	...
	public float getCategoryRate(NewModel model) {
		return (model.getListResult().size()/model.getTotalItem())*100;
	}
